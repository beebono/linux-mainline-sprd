...
static const struct snd_kcontrol_new sprd_audio_be_switch[S_SWITCH_CASE_MAX] = {
	...
	[S_FAST_P_CODEC] = SOC_DAPM_SINGLE("SWITCH", SND_SOC_NOPM, 0,
		1, 0),
	[S_FAST_P_CODEC_MM] = SOC_DAPM_SINGLE("SWITCH", SND_SOC_NOPM, 0,
		1, 0),
...
static const struct snd_soc_dapm_widget sprd_pcm_routing_widgets[] = {
	...
	SND_SOC_DAPM_AIF_IN("BE_IF_FAST_CODEC_P", "BE_DAI_FAST_CODEC_P",
		0, 0, 0, 0),
	SND_SOC_DAPM_AIF_IN("BE_IF_FAST_CODEC_P_MM", "BE_DAI_FAST_CODEC_P_MM",
		0, 0, 0, 0),
	...
	SND_SOC_DAPM_SWITCH("S_FAST_P_CODEC_MM", SND_SOC_NOPM,
		0, 0, &sprd_audio_be_switch[S_FAST_P_CODEC_MM]),
...
static const struct snd_soc_dapm_route sprd_pcm_routing_intercon[] = {
	...
	/* S_FAST_P_CODEC_MM */
	{"S_FAST_P_CODEC_MM", "SWITCH", "FE_IF_MM_P"},
	{"BE_IF_FAST_CODEC_P_MM", NULL, "S_FAST_P_CODEC_MM"},
	/* S_OFFLOAD_CODEC */
...
static void sprd_platform_routing_remove(struct platform_device *pdev)
{
