...
//liyunfan@MULTIMEDIA.AUDIODRIVER.CODEC,add for pa driver,2023/06/16
...
static int vbc_rxpx_codec_sc27xx_late_probe(struct snd_soc_card *card)
{
	...
	snd_soc_dapm_ignore_suspend(snd_soc_card_to_dapm(card), "inter HP PA");
	snd_soc_dapm_ignore_suspend(snd_soc_card_to_dapm(card), "inter Spk PA");
	snd_soc_dapm_ignore_suspend(snd_soc_card_to_dapm(card), "inter Ear PA");
